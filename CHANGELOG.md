...
- Migrated the webview and extension host to TypeScript, bundled with esbuild.
- Split the renderer and game loop into focused modules under `src/webview/`.
- Extracted GLSL shaders into separate `.glsl` files.
